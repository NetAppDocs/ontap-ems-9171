...
(None).
*Syslog Message*::
Async-delete "%s" has finished on inode: %llu in volume (DSID: %llu, MSID: %llu). Number of files deleted: %llu, Number of directories deleted: %llu. Total number of bytes deleted: %llu.
*Parameters*::
